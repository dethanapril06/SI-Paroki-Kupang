        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <a href="{{ route('sekretariat.sakramen.pernikahan.create') }}" class="btn btn-primary my-2">
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                            ...
                            <tbody>
                                @forelse ($pernikahan as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->pernikahan->pasangan->nama ?? '-' }}</td>
                                        <td>
                                            <span class="badge bg-warning text-dark">
                                                {{ $jenisList[$item->pernikahan->jenis_pernikahan] ?? $item->pernikahan->jenis_pernikahan }}
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                ...
                                                <a href="{{ route('sekretariat.sakramen.pernikahan.edit', $item) }}"
                                                    class="btn btn-sm btn-outline-warning" title="Edit">
                                                    <i class="bi bi-pencil-square"></i>
                                                </a>
                                                <form
                                                    action="{{ route('sekretariat.sakramen.pernikahan.destroy', $item) }}"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center">Belum ada data pernikahan.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                    ...
                    <div class="mt-3">{{ $pernikahan->links() }}</div>
                </div>
            </div>
        </section>
    </div>
                ...
                document.querySelectorAll('.delete-form').forEach(function(form) {
                    form.addEventListener('submit', function(e) {
                        ...
                        Swal.fire({
                            ...
                            text: 'Data pernikahan yang dihapus tidak bisa dikembalikan.',
                            icon: 'warning',
