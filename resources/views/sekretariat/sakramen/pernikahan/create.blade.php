        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Form Tambah Pernikahan</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('sekretariat.sakramen.pernikahan.store') }}">
                            @csrf
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            name="nomor_surat" value="{{ old('nomor_surat') }}" placeholder="Opsional">
                                        @error('nomor_surat')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select @error('jenis_pernikahan') is-invalid @enderror"
                                            ...
                                            @foreach ($jenisList as $key => $label)
                                                <option value="{{ $key }}"
                                                    {{ old('jenis_pernikahan') === $key ? 'selected' : '' }}>
                                                    {{ $label }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="pasangan_nama" name="pasangan_nama" value="{{ old('pasangan_nama') }}"
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-check form-switch mt-2">
                                        <input class="form-check-input" type="checkbox" id="dispensasi"
                                            name="dispensasi" value="1" {{ old('dispensasi') ? 'checked' : '' }}>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="tanggal_nikah_katolik"
                                            name="tanggal_nikah_katolik" value="{{ old('tanggal_nikah_katolik') }}">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="tanggal_catatan_sipil"
                                            name="tanggal_catatan_sipil" value="{{ old('tanggal_catatan_sipil') }}">
                                    </div>
                                </div>
