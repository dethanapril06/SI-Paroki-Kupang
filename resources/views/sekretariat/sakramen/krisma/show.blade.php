        ...
        <section class="section">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0">Informasi Krisma</h4>
                    <div class="d-flex gap-2">
                        <a href="{{ route('sekretariat.sakramen.krisma.edit', $sakramen) }}"
                            class="btn btn-sm btn-outline-warning">
                            <i class="bi bi-pencil-square"></i> Edit
                        </a>
                        <form action="{{ route('sekretariat.sakramen.krisma.destroy', $sakramen) }}"
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h6 class="fw-bold text-muted mb-2">Detail Krisma</h6>
                            <table class="table table-borderless">
                                <tr>
                                    <th width="160">Nama Krisma</th>
                                    <td>{{ $sakramen->krisma->nama_krisma ?? '-' }}</td>
                                </tr>
                                <tr>
                                    <th>Uskup Pemberi</th>
                                    <td>{{ $sakramen->krisma?->uskup?->nama ?? '-' }}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
