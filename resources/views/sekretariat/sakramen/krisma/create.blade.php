...
@section('content')
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                <div class="card-header"><h4 class="card-title">Form Tambah Krisma</h4></div>
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('sekretariat.sakramen.krisma.store') }}">
                            @csrf
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label for="klerus_id">Klerus Pemimpin Misa</label>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('nama_krisma') is-invalid @enderror" id="nama_krisma" name="nama_krisma" value="{{ old('nama_krisma') }}" placeholder="Opsional">
                                ...
                                <div class="col-12 d-flex justify-content-end">
                                    <a href="{{ route('sekretariat.sakramen.krisma.index') }}" class="btn btn-light-secondary me-1 mb-1">Batal</a>
