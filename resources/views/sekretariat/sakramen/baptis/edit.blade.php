                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('sekretariat.sakramen.baptis.show', $sakramen) }}">Detail</a></li>
        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Form Edit Baptis</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form class="form form-vertical" method="POST"
                            action="{{ route('sekretariat.sakramen.baptis.update', $sakramen) }}">
                            @csrf
                            @method('PUT')
                            <div class="form-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('nomor_surat', $sakramen->nomor_surat) }}">
                                            @error('nomor_surat')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select @error('sumber_baptis') is-invalid @enderror"
                                                ...
                                                <option value="KATOLIK" {{ old('sumber_baptis', $sakramen->baptis->sumber_baptis) === 'KATOLIK' ? 'selected' : '' }}>Katolik</option>
                                                <option value="PROTESTAN" {{ old('sumber_baptis', $sakramen->baptis->sumber_baptis) === 'PROTESTAN' ? 'selected' : '' }}>Protestan</option>
                                            </select>
                                            @error('sumber_baptis')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-12 col-md-6" id="wrap-tgl-baptis">
                                        <div class="form-group">
                                            ...
                                            <input type="date"
                                                ...
                                                value="{{ old('tgl_baptis', $sakramen->baptis->tgl_baptis?->format('Y-m-d')) }}">
                                            @error('tgl_baptis')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('nama_baptis', $sakramen->baptis->nama_baptis) }}">
                                            @error('nama_baptis')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select @error('baptis_klerus_id') is-invalid @enderror"
                                                ...
                                                @foreach ($klerusKatolik as $k)
                                                    <option value="{{ $k->id }}"
                                                        {{ old('baptis_klerus_id', $sakramen->baptis->klerus_id) == $k->id ? 'selected' : '' }}>
                                                        {{ $k->nama }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-12 col-md-6 d-none" id="wrap-protestan">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('nama_pemberi_protestan', $sakramen->baptis->nama_pemberi_protestan) }}">
                                    ...
                                    <div class="col-12 col-md-6 d-none" id="wrap-gereja">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('nama_gereja_protestan', $sakramen->baptis->nama_gereja_protestan) }}">
                                    ...
                                    <div class="col-12 col-md-6 d-none" id="wrap-tgl-katolik">
                                        <div class="form-group">
                                            ...
                                            <input type="date"
                                                ...
                                                value="{{ old('tgl_diterima_katolik', $sakramen->baptis->tgl_diterima_katolik?->format('Y-m-d')) }}">
                                    ...
                                    <div class="col-12"><hr class="my-1"><small class="text-muted fw-bold">Wali Baptis</small></div>

                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label for="bapak_baptis_id">Bapak Baptis (Umat Terdaftar)</label>
                                            <select class="form-select" id="bapak_baptis_id" name="bapak_baptis_id">
                                                <option value="">-- Pilih atau isi manual --</option>
                                                @foreach ($umatWali as $u)
                                                    <option value="{{ $u->id }}"
                                                        {{ old('bapak_baptis_id', $sakramen->baptis->bapak_baptis_id) == $u->id ? 'selected' : '' }}>
                                                        {{ $u->nama }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="bapak_baptis_nama"
                                                name="bapak_baptis_nama"
                                                value="{{ old('bapak_baptis_nama', $sakramen->baptis->bapak_baptis_nama) }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" id="ibu_baptis_id" name="ibu_baptis_id">
                                                <option value="">-- Pilih atau isi manual --</option>
                                                @foreach ($umatWali as $u)
                                                    <option value="{{ $u->id }}"
                                                        {{ old('ibu_baptis_id', $sakramen->baptis->ibu_baptis_id) == $u->id ? 'selected' : '' }}>
                                                        {{ $u->nama }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="ibu_baptis_nama"
                                                name="ibu_baptis_nama"
                                                value="{{ old('ibu_baptis_nama', $sakramen->baptis->ibu_baptis_nama) }}">
                                        </div>
                                    </div>

                                    <div class="col-12 d-flex justify-content-end">
                                        <a href="{{ route('sekretariat.sakramen.baptis.show', $sakramen) }}"
