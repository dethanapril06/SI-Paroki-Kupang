...
@section('title', 'Edit Minyak Suci')

@section('content')
    <div class="page-heading">
        <div class="page-title mb-3">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last"><h3>Edit Minyak Suci</h3></div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('sekretariat.sakramen.minyak-suci.show', $sakramen) }}">Detail</a></li>
        ...
        <section class="section">
            <div class="card">
                <div class="card-header"><h4 class="card-title">Form Edit Minyak Suci</h4></div>
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('sekretariat.sakramen.minyak-suci.update', $sakramen) }}">
                            @csrf
                            @method('PUT')
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('tempat_terima') is-invalid @enderror" id="tempat_terima" name="tempat_terima" value="{{ old('tempat_terima', $sakramen->minyakSuci->tempat_terima) }}">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('nama_pemberi') is-invalid @enderror" id="nama_pemberi" name="nama_pemberi" value="{{ old('nama_pemberi', $sakramen->minyakSuci->nama_pemberi) }}">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('keterangan_sebab') is-invalid @enderror" id="keterangan_sebab" name="keterangan_sebab" rows="3">{{ old('keterangan_sebab', $sakramen->minyakSuci->keterangan_sebab) }}</textarea>
                                        @error('keterangan_sebab')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>
                                </div>
                                <div class="col-12 d-flex justify-content-end">
                                    <a href="{{ route('sekretariat.sakramen.minyak-suci.show', $sakramen) }}" class="btn btn-light-secondary me-1 mb-1">Batal</a>
