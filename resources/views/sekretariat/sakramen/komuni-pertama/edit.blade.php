...
@section('content')
    <div class="page-heading">
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('sekretariat.sakramen.komuni-pertama.show', $sakramen) }}">Detail</a></li>
        ...
        <section class="section">
            <div class="card">
                <div class="card-header"><h4 class="card-title">Form Edit Komuni Pertama</h4></div>
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('sekretariat.sakramen.komuni-pertama.update', $sakramen) }}">
                            @csrf
                            @method('PUT')
                            <div class="row g-3">
                                ...
                                <div class="col-12 d-flex justify-content-end">
                                    <a href="{{ route('sekretariat.sakramen.komuni-pertama.show', $sakramen) }}" class="btn btn-light-secondary me-1 mb-1">Batal</a>
