...
@section('title', 'Tambah Anggota DPP')
        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Form Tambah Anggota DPP</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('sekretariat.dpp.keanggotaan.store') }}">
                            @csrf
                            <div class="row g-3">
                                ...
                                <div class="col-12"><small class="fw-bold text-muted">Data Kepengurusan</small>
                                    <hr class="my-1">
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="bidang_tugas" name="bidang_tugas" value="{{ old('bidang_tugas') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select @error('status_aktif') is-invalid @enderror"
                                            ...
                                            @foreach ($listStatus as $s)
                                                <option value="{{ $s }}"
                                                    {{ old('status_aktif', 'Aktif') === $s ? 'selected' : '' }}>
                                                    {{ $s }}
                                                </option>
                                            @endforeach
                                        </select>
