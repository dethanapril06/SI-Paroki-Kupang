                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{ route('sekretariat.dpp.keanggotaan.show', $keanggotaan) }}">Detail</a></li>
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('sekretariat.dpp.keanggotaan.update', $keanggotaan) }}">
                            @csrf
                            @method('PUT')
                            <div class="row g-3">
                                ...
                                <div class="col-12 d-flex justify-content-end">
                                    <a href="{{ route('sekretariat.dpp.keanggotaan.show', $keanggotaan) }}"
