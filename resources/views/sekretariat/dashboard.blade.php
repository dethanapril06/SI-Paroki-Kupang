    ...
    <div class="page-content">
        <div class="page-heading">
            <div class="row align-items-center mb-4">
                <div class="col-md-6 col-12">
                    <h3 class="mb-0 text-dark fw-bold">Dasbor Sekretariat Paroki</h3>
                ...
                <div class="col-md-6 col-12 d-flex justify-content-md-end justify-content-start mt-3 mt-md-0">
                    <form action="{{ route('sekretariat.dashboard') }}" method="GET" class="d-flex align-items-center gap-2">
                        <label for="tahun" class="text-muted font-semibold text-nowrap mb-0">Tahun Analisis:</label>
                        <select name="tahun" id="tahun" class="form-select border-primary text-primary bg-white shadow-sm font-semibold" onchange="this.form.submit()" style="width: 130px; border-color: #435ebe; color: #435ebe; font-weight: 600;">
                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <h6 class="text-muted font-semibold">Total Umat</h6>
            ...
            <div class="col-12 col-lg-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title mb-0">Umat per Wilayah</h4>
                    </div>
                    <div class="card-body">
        ...
        <section class="row">
            ...
            <div class="col-12 col-lg-6">
                <div class="card">
                    <div class="card-header">
                                        <h4 class="card-title mb-0">Sakramen Tahun {{ $tahun }}</h4>
                                    </div>
                    <div class="card-body">
            ...
            <div class="col-12 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <h5 class="mt-3 mb-2 text-muted">Kategorial Aktif</h5>
        ...
        <section class="row">
            ...
            <div class="col-12 col-lg-6">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('sekretariat.kematian.index') }}" class="btn btn-sm btn-outline-secondary">
                            Lihat semua
                        </a>
                    </div>
            ...
            <div class="col-12 col-lg-6">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title mb-0">Dewan Pastoral Paroki</h4>
        ...
        <section class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title mb-0">Sakramen Terbaru</h4>
                        <a href="{{ route('sekretariat.sakramen.index') }}" class="btn btn-sm btn-outline-secondary">
                            Lihat semua
                        </a>
                    </div>
                    <div class="card-body p-0">
                                            ...
                                            <td>
                                                @php
                                                    $badgeColor = match ($s->jenis_sakramen) {
                                                        'BAPTIS' => 'bg-light-info text-info',
                                                        'KOMUNI_PERTAMA' => 'bg-light-success text-success',
                                                        'KRISMA' => 'bg-light-warning text-warning',
                                                        'PERNIKAHAN' => 'bg-light-danger text-danger',
                                                        'MINYAK_SUCI' => 'bg-light-secondary text-secondary',
