                ...
                <div class="col-md-5">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('sekretariat.umat.edit', $umat) }}" class="btn btn-sm btn-outline-warning">
                ...
                <div class="col-md-7">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Informasi Struktural</h5>
                        </div>
                        <div class="card-body">
                            <table class="table table-borderless table-sm">
                                <tr>
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Akun Login</h5>
                        </div>
                        <div class="card-body">
                            @if ($umat->user)
                                <table class="table table-borderless table-sm">
