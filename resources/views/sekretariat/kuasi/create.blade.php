        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Form Tambah Kuasi</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form class="form form-vertical" method="POST" action="{{ route('sekretariat.kuasi.store') }}">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                                placeholder="Masukkan nama kuasi" id="nama" name="nama"
                                                value="{{ old('nama') }}">
                                            @error('nama')
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat" rows="3"
                                                placeholder="Masukkan alamat kuasi">{{ old('alamat') }}</textarea>
                                            @error('alamat')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select @error('klerus_id') is-invalid @enderror"
                                                ...
                                                @foreach ($klerus as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ old('klerus_id') == $item->id ? 'selected' : '' }}>
