                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('sekretariat.stasi.index') }}">Daftar Stasi</a>
                            </li>
        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Form Edit Stasi</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form class="form form-vertical" method="POST"
                            action="{{ route('sekretariat.stasi.update', $stasi) }}">
                            @csrf
                            @method('PUT')
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                                id="nama" name="nama" placeholder="Masukkan nama stasi"
                                                value="{{ old('nama', $stasi->nama) }}">
                                            @error('nama')
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat" rows="3"
                                                placeholder="Masukkan alamat stasi">{{ old('alamat', $stasi->alamat) }}</textarea>
                                            @error('alamat')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="koordinator" name="koordinator" placeholder="Masukkan nama koordinator"
                                                value="{{ old('koordinator', $stasi->koordinator) }}">
                                            @error('koordinator')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                            ...
                                            <select class="form-select @error('paroki_id') is-invalid @enderror"
                                                ...
                                                @foreach ($paroki as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ old('paroki_id', $stasi->paroki_id) == $item->id ? 'selected' : '' }}>
                                                        {{ $item->nama }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group" id="kuasi-group">
                                            ...
                                            <select class="form-select @error('kuasi_id') is-invalid @enderror"
                                                ...
                                                @foreach ($kuasi as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ old('kuasi_id', $stasi->kuasi_id) == $item->id ? 'selected' : '' }}>
                                                        {{ $item->nama }}
                                                    </option>
                                                @endforeach
                                            </select>
