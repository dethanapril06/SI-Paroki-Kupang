        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <a href="{{ route('dewan_pastoral.keanggotaan.create') }}" class="btn btn-warning my-2">
        ...
        <section class="section">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                    ...
                    <form method="GET" action="{{ route('dewan_pastoral.keanggotaan.index') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a href="{{ route('dewan_pastoral.keanggotaan.show', $item) }}"
                                                    class="btn btn-sm btn-outline-info" title="Detail">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                                <a href="{{ route('dewan_pastoral.keanggotaan.edit', $item) }}"
                                                    class="btn btn-sm btn-outline-warning" title="Edit">
                                                    <i class="bi bi-pencil-square"></i>
                                                </a>
                                                <form action="{{ route('dewan_pastoral.keanggotaan.destroy', $item) }}"
