...
@section('title', 'Dasbor Pastor Paroki')
        ...
        <div class="page-heading">
            <div class="row align-items-center mb-4">
                <div class="col-md-6 col-12">
                    <h3 class="mb-0 text-dark fw-bold">Dasbor Pastor Paroki</h3>
                ...
                <div class="col-md-6 col-12 d-flex justify-content-md-end justify-content-start mt-3 mt-md-0">
                    <form action="{{ route('pastor.dashboard') }}" method="GET" class="d-flex align-items-center gap-2">
                        <label for="tahun" class="text-muted font-semibold text-nowrap mb-0">Tahun Analisis:</label>
                        <select name="tahun" id="tahun" class="form-select border-burgundy text-burgundy bg-white shadow-sm" onchange="this.form.submit()" style="width: 130px; border-color: #800020; color: #800020; font-weight: 600;">
                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start">
                                        <div class="stats-icon burgundy mb-2">
            ...
            <div class="col-12 col-lg-6">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('pastor.dpp.index') }}" class="btn btn-sm btn-outline-secondary">
                            Lihat semua
                        </a>
                    </div>
                    <div class="card-body p-0">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('pastor.sakramen.index') }}" class="btn btn-sm btn-outline-secondary">
                            Lihat semua
                        </a>
                    </div>
                    <div class="card-body p-0">
