...
@section('title', 'Krisma — ' . $anggota->nama)
@section('content')
<div class="page-heading">
    <div class="page-title mb-3">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3><i class="bi bi-fire text-warning me-2"></i>Krisma — {{ $anggota->nama }}</h3>
            </div>
    ...
    <section class="section">
        ...
        @if ($sakramen)
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('portal.sakramen-anggota.krisma.edit', $anggota) }}" class="btn btn-sm btn-outline-primary">
        ...
        @else
            <div class="alert alert-light-info color-info mb-3">
                <i class="bi bi-info-circle-fill me-2"></i>Data Krisma <strong>{{ $anggota->nama }}</strong> belum tercatat.
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('portal.sakramen-anggota.krisma.store', $anggota) }}" method="POST">
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nama_krisma" class="form-control" value="{{ old('nama_krisma') }}">
                            </div>
                            <div class="col-md-6">
