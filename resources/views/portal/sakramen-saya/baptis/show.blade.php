...
@section('title', 'Baptis Saya')
@section('content')
<div class="page-heading">
    <div class="page-title mb-3">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3><i class="bi bi-droplet-fill text-info me-2"></i>Sakramen Baptis</h3>
            </div>
    ...
    <section class="section">
        ...
        @if ($sakramen && $baptis)
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('portal.sakramen-saya.baptis.edit') }}" class="btn btn-sm btn-outline-primary">
        ...
        @else
            ...
            <div class="alert alert-light-info color-info mb-3">
                <i class="bi bi-info-circle-fill me-2"></i>Data Baptis Anda belum tercatat. Silakan isi formulir berikut.
            </div>
            <div class="card">
                <div class="card-header"><h5 class="card-title mb-0">Input Data Baptis</h5></div>
                <div class="card-body">
                    @include('portal.sakramen-saya.baptis._form', ['action' => route('portal.sakramen-saya.baptis.store'), 'method' => 'POST'])
                </div>
            </div>
        @endif
    </section>
