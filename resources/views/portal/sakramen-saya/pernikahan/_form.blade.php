...
<form action="{{ $action }}" method="POST">
    ...
    <div class="d-flex gap-2 justify-content-end mt-4">
        <a href="{{ route('portal.sakramen-saya.pernikahan') }}" class="btn btn-light-secondary">Batal</a>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (!pasanganSelect || !namaManual || !agamaManual || !agamaOtomatis) {
                return;
            }
