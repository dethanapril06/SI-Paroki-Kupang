...
@section('title', 'Komuni Pertama Saya')
@section('content')
<div class="page-heading">
    <div class="page-title mb-3">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3><i class="bi bi-cup-hot-fill text-success me-2"></i>Komuni Pertama</h3>
            </div>
        ...
        @if ($sakramen)
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('portal.sakramen-saya.komuni.edit') }}" class="btn btn-sm btn-outline-primary">
                ...
                <div class="card-body">
                    <table class="table table-borderless mb-0">
                        ...
                        <tr><td class="text-muted fw-semibold">Pemberi Komuni</td><td>{{ $sakramen->klerus?->nama ?? '-' }}</td></tr>
                    </table>
                </div>
            </div>
        @else
            <div class="alert alert-light-info color-info mb-3">
                <i class="bi bi-info-circle-fill me-2"></i>Data Komuni Pertama Anda belum tercatat.
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('portal.sakramen-saya.komuni.store') }}" method="POST">
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-6">
