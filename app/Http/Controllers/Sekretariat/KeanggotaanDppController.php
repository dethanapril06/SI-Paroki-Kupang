...
class KeanggotaanDppController extends Controller
{
     ...
     * GET /sekretariat/dpp/keanggotaan
     */
    public function index(Request $request)
    {
        ...
        return view('sekretariat.anggota-dpp.index', [
            'anggota'     => $anggota,
     ...
     * GET /sekretariat/dpp/keanggotaan/create
     */
    public function create()
    {
        ...
        return view('sekretariat.anggota-dpp.create', [
            'umatList'    => $umatList,
            'listJabatan' => KeanggotaanDpp::JABATAN,
            'listStatus'  => KeanggotaanDpp::STATUS,
        ]);
    ...
    /**
     * Simpan anggota baru + otomatis buat akun user dewan_pastoral.
     * POST /sekretariat/dpp/keanggotaan
     */
    public function store(KeanggotaanDppRequest $request)
    {
        ...
        if ($validated['jabatan'] === 'Ketua') {
            ...
            if ($user) {
                ...
                return redirect()
                    ->route('sekretariat.dpp.keanggotaan.index')
     ...
     * GET /sekretariat/dpp/keanggotaan/{keanggotaan}
     */
    public function show(KeanggotaanDpp $keanggotaan)
    {
        ...
        return view('sekretariat.anggota-dpp.show', compact('keanggotaan', 'user'));
    }

    /**
     * Form edit anggota.
     * GET /sekretariat/dpp/keanggotaan/{keanggotaan}/edit
     */
    public function edit(KeanggotaanDpp $keanggotaan)
    {
        ...
        return view('sekretariat.anggota-dpp.edit', [
     ...
     * PUT /sekretariat/dpp/keanggotaan/{keanggotaan}
     */
     ...
     * DELETE /sekretariat/dpp/keanggotaan/{keanggotaan}
     */
